...
export function MiniPlayer() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-3 mb-3 overflow-hidden rounded-md border border-parchment/[0.14] bg-ink/80 shadow-2xl shadow-black/60 backdrop-blur-xl sm:mx-0 sm:mb-0 sm:rounded-none sm:border-x-0 sm:border-b-0">
