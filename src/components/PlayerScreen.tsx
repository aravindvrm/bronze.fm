  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Stacked on a phone, side by side on desktop — a tall column of
            artwork above controls leaves a wide window mostly empty. */}
            ...
            {volumeSupported && (
              <div className="mt-6 flex items-center gap-3">
                ...
                <input
                  ...
                  aria-label="Volume"
                  className="h-1 w-full cursor-pointer appearance-none bg-parchment/20 accent-ember"
                />
              </div>
            )}
