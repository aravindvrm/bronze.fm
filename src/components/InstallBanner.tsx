  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="pointer-events-auto fixed inset-x-4 bottom-[calc(var(--safe-b)+1rem)] z-40 flex items-center gap-3 rounded-md border border-parchment/[0.14] bg-ink/90 px-4 py-3 shadow-[0_8px_30px_rgba(0,0,0,0.4)] backdrop-blur-xl sm:inset-x-auto sm:bottom-[calc(var(--safe-b)+7rem)] sm:right-6 sm:w-80"
      >
